...
public class BardakManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ObserverSystem.instance.oyunBasladi += oyunBasla;
        ObserverSystem.instance.bardakSecildi += bardaklarinTiklanilabilirlikKapa;
        ObserverSystem.instance.karistirmaBitti += bardaklarinTiklanilabilirlikkAc;
        ObserverSystem.instance.bardakSecildi += dogruBardagiGoster;
        ObserverSystem.instance.restart += oyunBasla;
    }

    public void oyunBasla()
    {
        ObserverSystem.instance.baslangic?.Invoke();
    ...
    IEnumerator Karistir(int birinciSira, int ikinciSira, int sira)
    {
        ...
        ObserverSystem.instance.bardakHareketEtti?.Invoke();
    ...
    {
        ObserverSystem.instance.karistirmaBitti?.Invoke();
    }
    ...
    private bool secilenBardakDogruMu()
    {
        ...
        {
            ObserverSystem.instance.win?.Invoke();
            return true;
        }
        ObserverSystem.instance.lose?.Invoke();
        return false;
    }
